...
$toEmail = "marcusicaromc@gmail.com"; // Replace Your Email Address
...
$fromEmail = "marcusicaromc@marcusicaro.com.br";  // Replace Company's Email Address (preferably currently used Domain Name)
$fromName = "Marcus"; // Replace Company Name
...
$mail->SMTPAuth = true;
$mail->Username = "marcusicaromc@marcusicaro.com.br";
$mail->Password = "N3wp4ss!";
$mail->SMTPSecure = 'tls';
$mail->Port = 587;
...
if (filter_var($toEmail, FILTER_VALIDATE_EMAIL)) {
	...
	$success = "Thank you for contacting me, I'll answer as soon as I can."; // Success Message
